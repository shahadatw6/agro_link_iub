                      ...
                      <tbody>
                        ...
                        if (mysqli_num_rows($sql) > 0) {
                          while ($row = mysqli_fetch_assoc($sql)) {
                            ...
                            $name_user = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM employee WHERE employee_ID='$user_id'"));
                            $contact = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM employee WHERE employee_ID='$user_id'"));
                            $address = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM employee WHERE employee_ID='$user_id'"));
                        ?>
                            <tr>
                              <td>
                                <?php echo $row['id']; ?>
                              ...
                              <td>
                                <p><?php echo $name_user['emp_name'] ?></p>
                                <p><?php echo $contact['emp_contact'] ?></p>
                              <td>
