...
if (isset($_POST['submit'])) {
    ...
    $best_before = get_safe_value($_POST['best_before']);
    ...
    if (mysqli_num_rows(mysqli_query($con, $sql)) > 0) {
        ...
        if ($id == '') {
            if ($type != 'image/jpeg' && $type != 'image/png' && $type != 'image/jpg') {
                $image_error = "Invalid image format. Please select png/jpeg/jpg format";
            } else {
                $image = $product_name . '_' . $_FILES['image']['name'];
                $targetPath = SERVER_PRODUCT_IMAGE. $image;
            ...
            <div class="card-body">
                <form class="forms-sample" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" placeholder="Best Before" name="best_before" value="<?php echo $best_before ?>">
                    </div>
