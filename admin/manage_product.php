              ...
              <div class="card">
                <div class="card-body">
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
                      <label for="exampleInputEmail3" required>Size/Weight</label>
                      <textarea name="product_detail" class="form-control" placeholder="Weight or size or both"><?php echo $product_detail?></textarea>
                    </div>
					
					<div class="form-group">
                      <label for="exampleInputEmail3" required>Colour</label>
                      <textarea name="product_detail" class="form-control" placeholder="shapes and colour"><?php echo $product_detail?></textarea>
                    </div>
					...
					<div class="form-group">
                      ...
                      <textarea name="product_detail" class="form-control" placeholder="price per unit "><?php echo $product_detail?></textarea>
                    </div>
